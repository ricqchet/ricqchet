...
> **Monorepo:** this is the server subproject (`ricqchet-web/`) of the [Ricqchet monorepo](../CLAUDE.md). Run all `mix` commands and resolve every relative path in this file from inside `ricqchet-web/`. The TypeScript client lives in `../ricqchet-ts-client/`.
